    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('introduccion', tinymce.models.HTMLField(default='Escribe aquí el texto de la introducción...', help_text='La intro se muestra en la página principal de las Noticas', max_length=15000)),
