"""
Django settings for kradleco project.
...
INSTALLED_APPS = [
    ...
    'tinymce',
    'kradleco.apps.users',
    'kradleco.apps.landing',
    'kradleco.apps.noticias',
    'kradleco.apps.payments',
    'kradleco.apps.home',
    'allauth',
    'allauth.account',
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(PROJECT_ROOT, 'templates'), 'templates', 'kradleco/templates',
                 os.path.join(BASE_DIR, 'kradleco/templates'), ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'kradleco.wsgi.application'
